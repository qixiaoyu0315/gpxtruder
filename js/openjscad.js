...
OpenJsCad.Viewer.prototype = {
  ...
  setBaseMap: function (url, scale, mapw, maph, dlcallback) {
    ...
    var that = this;
    this.maptexture = GL.Texture.fromURL(url, {
      callback: function (mapImage) {
        that.onDraw();
...
OpenJsCad.parseJsCadScriptASync = function (script, options, callback) {
  var baselibraries = [
    "https://cdn.jsdelivr.net/gh/qixiaoyu0315/gpxtruder@tag3/csg.js",
    "https://cdn.jsdelivr.net/gh/qixiaoyu0315/gpxtruder@tag3/openjscad.js"
  ];
...
OpenJsCad.Processor.prototype = {
  ...
  generateOutputFile: function () {
    ...
    if (this.hasValidCurrentObject) {
      // Skip FileSystem API and use Blob URL directly
